...
axis.break(1, 700, breakcol="snow", style="gap")
axis.break(1, 700*(1+0.02), breakcol="black", style="slash")
axis.break(3, 700*(1+0.02), breakcol="black", style="slash")
#axis(1, at=800)

gap.plot(combo.data$time,log10(combo.data$spore), gap=c(700,1500), gap.axis="x", 
         type = "p", pch = 21, col="grey50", bgcol = "grey50", bg = "grey50", 
         add = TRUE, cex = 1.25, lwd = 0.75)





gap.plot(data.all$time,log10(data.all$veg), gap=c(700,1500), gap.axis = "x", pch = 21,
        col="grey80", bg = "grey80", ylim= c(4.5, 8.7), cex = 1.25, 
        xtics=c(0:700,1500:2000), xticlab=c(0:700,1500:2000), lwd = 0.75, 
        cex.axis = 1.25, xlab = NA, ylab = NA, xlim = c(-25, 2000),
        yaxt = "n", xaxt = "n")

points(xgap, log10(data.all$spore), pch = 21, lwd = 0.75, bg = "grey50", 
      col = "grey50", cex = 1.25)

abline(v=seq(699.99,700.09,0.001), col="white")
abline(v=seq(799.99,800.09,0.001), col="red")
axis.break(1,2,style="slash") 


# xgap (a, b, c) = plot things greater than a and less than b otherwise, it's in gap
xgap <- ifelse(data.all$time > 1500, data.all$time-1295, data.all$time)
plot(xgap, log10(data.all$veg), pch = 21, bg = "grey80", cex = 1.25, 
     col = "grey80", lwd = 0.75, cex.axis = 1.25, xlab = NA, ylab = NA,
     xlim = c(-25, 2000), ylim = c(4.5, 8.7), yaxt = "n", xaxt = "n")
